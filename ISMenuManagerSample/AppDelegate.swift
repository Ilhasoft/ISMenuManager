...
extension AppDelegate : ISMenuControllerDelegate {
    func menuItemDidTap(menuController: ISMenuController, menuItem: ISMenuItem, index: Int) {
        menuController.addMenuItem(menuItem: ISMenuItem(icon: #imageLiteral(resourceName: "home"), title: "Home \(index)", controller: nil))
    }
}
